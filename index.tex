...
\hypersetup{
  pdftitle={veda-documentation},
  pdfauthor={VEDA Team (NASA IMPACT and Development Seed)},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\addcontentsline{toc}{section}{Welcome to documentation about the VEDA
API and Datasets}
...
\addcontentsline{toc}{chapter}{VEDA APIs}
...
\addcontentsline{toc}{subsection}{Development, aka Dev (experimental
work, expected downtime)}
...
\addcontentsline{toc}{subsection}{Staging (maintenance will be
announced):}
...
\addcontentsline{toc}{subsection}{Production: COMING SOON}
...
\addcontentsline{toc}{section}{2016-2022 Timeseries of Monthly NO2 Using
\texttt{rioxarray}, \texttt{satsarch} and \texttt{stackstac}}
